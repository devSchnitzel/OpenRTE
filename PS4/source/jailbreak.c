...
int jailbreak(struct thread *td, void *uap) {
    ...
    *(uint64_t *)0xFFFFFFFF8323A4E0 = 0x9990001;
    //*(uint32_t *)0xFFFFFFFF827C7B36 = 0x09990001;

    // Enable Process Syscall
    ...
    *(uint64_t *)0xFFFFFFFF8323A4E0 = 0x9990001;
    ...
    // Déactive la vérifiaction de l'act
    *(uint64_t *)0xFFFFFFFF827C8F40 = 0xB800000000C39090;

    // Déactive la vérification du keystone
    *(uint64_t *)0xFFFFFFFF827B12F0 = 0xB800000000C39090;
